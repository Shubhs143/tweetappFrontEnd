...
import imgProfile1 from '../../assets/images/profile.jpeg';
...
import imgLikeBlue from '../../assets/images/like-red.png';
                    ...
                    <div style={{ width: "100%" }}>
                        {
                            ...
                            <>
                                ...
                                <div className="shadow" style={{ alignItems: "flex-start", display: "flex", flexDirection: "column", borderRadius: 10, margin: 30, marginTop: 0, backgroundImage:'url("https://htmlcolorcodes.com/assets/images/colors/baby-blue-color-solid-background-1920x1080.png")', 
                                    ...
                                    <p style={{ marginLeft: 20, marginTop: 20, fontSize: 12, fontFamily: "OpenSans-Regular" }}>You are replying to <span style={{ color: "gray" }}>{tweet.userTweetId}</span> </p>
